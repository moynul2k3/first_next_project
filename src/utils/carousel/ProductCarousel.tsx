                        ...
                        <div className="splide__track mt-3 py-5 pb-10">
                            <ul className="splide__list h-auto max-md:w-[180px] md:w-[300px] mt-5">
                                {Products.map((Product) => (
                                    <li key={Product.id} className="splide__slide relative max-xl:rounded-md xl:rounded-xl overflow-hidden shadow-[-1px_0px_5px_#f002,1px_0px_5px_#0004] hover:shadow-[-1px_0px_5px_#CC1554,1px_0px_5px_#6A4385] transition-shadow duration-300 swiper-slide max-md:pb-2 md:pb-3 lg:pb-5">
                                        <Link href="/about" className="">
                                            <div className="absolute max-md:top-1 md:top-2 max-md:right-1 md:right-2 max-xl:h-6 max-xl:w-16 xl:h-8 xl:w-28 flex justify-center items-center max-xl:rounded xl:rounded-md bg-gradient_bg border-[2px] border-white/30">
                                                <p className="text-white font-semibold max-xl:text-[10px] xl:text-sm ">40% OFF</p>
                                            </div>
                                            <div className="w-full flex justify-center">
                                                <Image src={Product.image} alt={Product.name} width={300} height={400} className="max-xl:h-[150px] xl:h-[250px]" />
                                            </div>
                                            <div className="w-full text-center max-xl:mt-[2px] xl:mt-2 max-xl:px-1 xl:px-4">
                                                ...
                                                <div className="flex justify-between items-center max-xl:mt-[1px] xl:mt-2 max-xl:pb-1 xl:pb-3 max-xl:px-3 xl:px-1">
                                                    ...
                                                    <p className="max-xl:text-[10px] xl:text-[12px] font-semibold flex justify-center items-center">
                                                        ...
                                                        <span className="noto_sans max-xl:text-[14px] xl:text-[20px]">৳</span>&nbsp;
                                                        <span className="max-xl:text-[12px] xl:text-[16px]">400</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </Link>
                                        <div className="flex justify-between items-center max-xl:gap-1 xl:gap-2 px-2">
                                            <Link href="/" className="w-full max-xl:h-7 xl:h-10 flex justify-center items-center max-xl:rounded-sm xl:rounded-md bg-gradient_bg hover:opacity-85 max-md:text-xs text-white">Buy Now</Link>
                                            <Link href="/" className="max-md:w-10 md:w-full max-xl:h-7 xl:h-10 flex justify-center items-center max-xl:rounded-sm xl:rounded-md bg-gradient_bg hover:opacity-85 max-md:text-xs text-white">
