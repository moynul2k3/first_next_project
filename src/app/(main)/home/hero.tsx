		...
		<main className='h-auto w-full brightness-h-80 relative'>
			{ bannerData.length > 0 && (
				<div className=' max-md:h-[400px] md:h-[400px] xl:h-[600px] w-full'>
					<div className='absolute top-0 left-0 md:bg-gradient-to-br from-black to-transparent w-full h-full z-30 px-10 flex max-xl:justify-end max-xl:pb-12 xl:justify-center items-start  flex-col gap-5 max-md:px-4 md:px-8 lg:px-20 xl:px-32'>
